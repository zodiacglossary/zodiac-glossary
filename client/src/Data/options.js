...
export const searchFieldTypes = [
  ...
  { id: 1,  table: 'lemmata',     field: 'editor',            label: 'Editor',              inputType: 'text',                                      },
  { id: 2,  table: 'lemmata',     field: 'language_id',       label: 'Language',            inputType: 'dropdown',  objectName: 'languageOptions',      },
  { id: 3,  table: 'lemmata',     field: 'partofspeech_id',   label: 'Part of Speech',      inputType: 'dropdown',  objectName: 'partOfSpeechOptions',  },
  ...
  { id: 6,  table: 'lemmata',     field: 'translation',       label: 'Literal Translation', inputType: 'text',                                      },
  // { id: 7,  table: 'lemmata',   field: 'primary_meaning',   label: 'Primary Meaning',     inputType: 'text',                                      },
  { id: 8,  table: 'lemmata',     field: 'loan_language_id',  label: 'Source Language',     inputType: 'dropdown',  objectName: 'languageOptions',      },
  // { id: 9,  table: 'lemmata',   field: 'loan_type',         label: 'Type of Loan',        inputType: 'dropdown',  objectName: 'loanTypes'             },
  { id: 10, table: 'meanings',    field: 'value',             label: 'Meaning',             inputType: 'text',                                      },
  { id: 11, table: 'meanings',    field: 'category',          label: 'Category',            inputType: 'text',                                      },
  { id: 12, table: 'variants',    field: 'original',          label: 'Original Text',       inputType: 'text',                                      },
  { id: 13, table: 'variants',    field: 'transliteration',   label: 'Transliteration',     inputType: 'text',                                      },
  { id: 14, table: 'quotations',  field: 'provenance',        label: 'Provenance',          inputType: 'text',                                      },
  { id: 15, table: 'quotations',  field: 'publication',       label: 'Publication',         inputType: 'text',                                      },
];
